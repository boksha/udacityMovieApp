...
public class MostPopularMovieRealm extends RealmObject {
    @Index
    @PrimaryKey
    ...
    public MostPopularMovieRealm() {
    }

    public MostPopularMovieRealm(Integer id, String mTitle, String mImageUrl, String mDescription, String mUserRating, String mReleaseDate) {
        this.mId = id;
        this.mTitle = mTitle;
        this.mImageUrl = mImageUrl;
        this.mDescription = mDescription;
    ...
    public MostPopularMovieRealm(Movie m) {
        this.mId = m.getId();
